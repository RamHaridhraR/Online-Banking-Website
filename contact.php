			...
			<div class="contact_wthreerow agileits-w3layouts">
				<div class="col-md-5 agileits_w3layouts_contact_gridl">
					<div class="agileits_mail_grid_right_grid">
						<h4>Info</h4>
						<p><p>For more details contact our bank Customer Care through call or through mail. 
						       We will be available for 24X7 hours.</p></p>
					</div> 
					<div class="agileits_mail_grid_right_grid">
						<h4>Contact Info</h4>
						<ul class="contact_info">
							<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>L&T ByPass, Sri Shakthi Nagar, Chinniyampalayam, TN</li>
							<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@siet.ac.in">info@siet.ac.in</a></li>
							<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+91-422-2369900</li>
						</ul>
					</div>
				</div>
...
<div class="agile-footer w3ls-section">
	<div class="container">
		...
		<div class="col-md-5 agileinfo-sub">
			<h6>Contact your branch office to know more..</h6>
		</div>
		<div class="clearfix"></div>
     </div>
</div>	 
